insert into post (id, title) values (1, 'JPA에서 일대일 연관 관계 정의시 고려할 점1')
insert into post_details (content, post_id) values ('안녕하세요. 여러분 게시물 내용1', 1)

insert into post (id, title) values (2, 'JPA에서 일대일 연관 관계 정의시 고려할 점2')
insert into post_details (content, post_id) values ('안녕하세요. 여러분 게시물 내용2', 2)

insert into post (id, title) values (3, 'JPA에서 일대일 연관 관계 정의시 고려할 점3')
insert into post_details (content, post_id) values ('안녕하세요. 여러분 게시물 내용3', 3)

insert into post (id, title) values (4, 'JPA에서 일대일 연관 관계 정의시 고려할 점4')
